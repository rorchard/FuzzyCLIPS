static char rcsid[] = "$Header: /dist/CVS/fzclips/src/scanner.c,v 1.3 2001/08/11 21:07:52 dave Exp $" ;
...
/***************************************/
   ...
   static BOOLEAN          UnTokenIsAvailable = FALSE;
#endif
